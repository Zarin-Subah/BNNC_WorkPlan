            ...
            <div class="col-md-12">
                <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-3 print-hidden">
                                    <div class="pull-left">
                                        <a href="<?php echo site_url('reports/work_plan_list'); ?>" class="btn btn-sm btn-success">Back</a>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td><?php
                                                if ($previous_sub_activity != $row['sub_activity_name']) {
                                                    echo $row['sub_activity_name'];
                                                }
                                                $previous_sub_activity = $row['sub_activity_name'];
                                                ?></td>
                        ...
                        <?php
                        if (!empty($master_row['signatory_name'])) {
                        ?>
                            <div style="margin-left:80%;margin-top:60px;text-align: center;font-weight: bold;font-size: 12px;">
                                <img src="<?php echo base_url('_^_imgUpload/signature/' . $master_row['signature']); ?>" style="height:45px;" /><br />
                                <?php
                                $CI = &get_instance();
                                $date = date('d/m/Y', strtotime($master_row['signature_date'])) . "<br/>";
                                echo $CI->en2bn($date);
                                echo $master_row['signatory_name'] . "<br/>";
                                echo $master_row['signatory_designation'] . "<br/>";
                                ?>
                            </div>
                        <?php } ?>
                    </div>
