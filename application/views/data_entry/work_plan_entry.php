...
<script>
    ...
    function addRow(tableID) {
        ...
        if ((thematic_area_id < 1) || (thematic_area_id == "")) {
            ...
            element10.setAttribute("required", "yes");
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width:100%" id="dataTable">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="budget[]" class="custom-input" required></td>
                                            <td>
                                                <select id="responsibility_list1" class="custom-input" multiple="multiple">
                                                    <option value="">Select</option>
                                                    <?php
                                                ...
                                                <a href="javascript:void(0)" class="add-button" onclick="SetResponsibilities(1)">Select</a>
                                                <textarea id="responsibilities1" name="responsibilities[]" class="custom-input" readonly="readonly"></textarea>
                                            </td>
                                            <td>
                                                <select id="partner_list1" class="custom-input" multiple="multiple">
                                                    <option value="">Select</option>
                                                    <?php
                                                ...
                                                <a href="javascript:void(0)" class="add-button" onclick="SetPartners(1)">Select</a>
                                                <textarea id="partners1" name="partners[]" class="custom-input" readonly="readonly"></textarea>
                                            </td>
