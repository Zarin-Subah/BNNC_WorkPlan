                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" id="period" name="period" required>
                                                <option value="<?php echo $master_row['period']; ?>"><?php echo $master_row['period']; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="progress_status[]" required>
                                                        ...
                                                        <option value="Not Started" <?php echo ($row['progress_status'] == 'Not Started') ? 'selected' : '' ?>>Not Started</option>
                                                        <option value="Ongoing" <?php echo ($row['progress_status'] == 'Ongoing') ? 'selected' : '' ?>>Ongoing</option>
                                                        <option value="Completed" <?php echo ($row['progress_status'] == 'Completed') ? 'selected' : '' ?>>Completed</option>
                                                    </select>
                                                </td>
                                                <td><input type="text" name="progress_value[]" id="progress_value" class="custom-input" value="<?php echo $row['progress_value']; ?>"></td>
                                                <td><textarea name="progress_comment[]" id="progress_comment" class="custom-input"><?php echo $row['progress_comment']; ?></textarea>
                                                <td>
                                                    <?php
                                                    if ($row['quarter1'] == 'Y') {
                                                ...
                                                <td><input type="text" name="expenditure[]" id="expenditure" class="custom-input" value="<?php echo $row['expenditure']; ?>" required></td>
                                                <td>
                                                    <div class="div_like_input">
