                        ...
                        <div class="col-md-12">
                            <form method="POST" action="">
                                ...
                                <div class="form-row" style="margin-bottom:-40px;">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="period" class="col-form-label">পিরিয়ড</label>
                                        <select class="form-control" id="period" name="period">
                                            <option value="">Select</option>
                                            <?php
                                            foreach ($periods as $period) {
                                            ?>
                                                <option value="<?php echo $period['period_en']; ?>" <?php
                                                                                                    if (!empty($_POST)) {
                                                                                                        if ($period['period_en'] == $_POST['period']) {
                                                                                                            echo "selected";
                                                                                                        }
                                                                                                    }
                                                                                                    ?>><?php echo $period['period_bn']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            ?>
                                <tr class="bg<?php echo $row['finance_year']; ?>">
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?php echo site_url('data_entry/work_progress_edit/' . $row['id']); ?>" class="btn btn-sm btn-warning" title="Edit">Edit</a>
